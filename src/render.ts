...
const BODY_COPY =
    [
        //`I'm Kenan, and I specialize in developing advanced AI systems for the compliance, intelligence and high-frequency algorithmic trading sector.`,
        `I'm Kenan, and I build advanced AI systems.`,
        'With a strong belief in the freedom of information, my research bridges the gap between nature-inspired algorithms and complex applications, enabling the exploitation of data from unique angles.',
    ].join(' ')
...
export const shared = /* css */ `
	:root {
		...
		--xcolor-text-dark: #255DF6;
		--color-text-dark: #ec2400;
...
export const main = (props: Props & Main) => {
    ...
    const days = (days: Year['days']) =>
        days.map((level) => `<div class="dot dot--${level}"></div>`)
            .join('');
